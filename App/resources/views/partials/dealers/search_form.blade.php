...
<div class="col-sm-6">
    <small style="float:right;color:black;">Searching {{ $dealers->count() }} Dealerships</small>
    <br>
    <small style="float:right;color:black;">and {{ $total_listings }} vehicles!</small>
</div>
<!--Google Maps-->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        all_dealers = {!! json_encode($dealers->toArray()); !!};
...
<form action="{{ currentPage() }}">
    ...
    <div class="col-md-6">
        ...
        from ZIP: <input class="small-field" type="text" value="{{ old('zip') }}" name="zip"/>
    </div>
    <div class="clear"></div>
